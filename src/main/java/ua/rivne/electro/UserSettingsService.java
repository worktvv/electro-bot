...
public class UserSettingsService {
    ...
    // chatId -> list of notification message IDs
    private final Map<Long, Set<Integer>> notificationMessageIds;
    ...
    public UserSettingsService() {
        ...
        this.notificationMessageIds = new ConcurrentHashMap<>();
        loadSettings();
    }
    ...
    /**
     * Adds a notification message ID for user.
     */
    public void addNotificationMessageId(long chatId, int messageId) {
        notificationMessageIds.computeIfAbsent(chatId, k -> ConcurrentHashMap.newKeySet()).add(messageId);
    }

    /**
     * Gets and clears all notification message IDs for user.
     */
    public Set<Integer> getAndClearNotificationMessageIds(long chatId) {
        Set<Integer> ids = notificationMessageIds.remove(chatId);
    ...
    public boolean hasNotifications(long chatId) {
        Set<Integer> ids = notificationMessageIds.get(chatId);
